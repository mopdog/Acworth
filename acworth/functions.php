...
function reverie_css() {
  if ( !is_admin() ) {
     ...
     wp_enqueue_style( 'style' );
	  ...
	  wp_register_style( 'flex',get_template_directory_uri() . '/css/flexslider.css', false );
	 ...
	 wp_register_style( 'google_font2',"http://fonts.googleapis.com/css?family=Arvo:400,700", false );
...
global $is_IE;
  ...
  // Enqueue to header
  	 wp_register_script( 'prefix', get_template_directory_uri() . '/js/prefix-free.js', array( 'jquery' ) );
  ...
  // Enqueue to footer
  	 ...
  	 wp_register_script( 'app', get_template_directory_uri() . '/js/script.js', array( 'jquery' ), false, true );
